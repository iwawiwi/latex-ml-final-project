...
\twocolumn[
\icmltitle{Multi-label Classification using Problem Transformation Approach and Ensemble-based Learning Framework}
...
\icmlkeywords{ensemble framework, multi-label learning, multi-label classification, problem transformation approach}
...
In this paper, the experiment on multi-label classification using ensemble-based learning framework have been done. Many real world problem can be seen as multi-label classification problem and more difficult to solve than common single-label classification. To overcome this problem, problem transformation approach was adopted. A new voting scheme for ensemble system also proposed. Several weak classifier such as Support Vector Machines (SVM), decision tree, and Extreme Learning Machine (ELM) are included in the experiment. The system then evaluated using some publicly multi-label classification dataset and several performance metrics such as Hamming loss, accuracy, precision, and recall.
...
\vskip 0.2in
	\begin{subfigure}{}
	\centering
		\includegraphics[height=1.5in]{assets/[EMOTION]accuracy_profile_@10-fold_cv.pdf}
		\includegraphics[height=1.5in]{assets/[EMOTION]precision_profile_@10-fold_cv.pdf}
		\includegraphics[height=1.5in]{assets/[EMOTION]recall_profile_@10-fold_cv.pdf}
		\includegraphics[height=1.5in]{assets/[SCENE]accuracy_profile_@10-fold_cv.pdf}
		\includegraphics[height=1.5in]{assets/[SCENE]precision_profile_@10-fold_cv.pdf}
		\includegraphics[height=1.5in]{assets/[SCENE]recall_profile_@10-fold_cv.png}
		\includegraphics[height=1.5in]{assets/[YEAST]accuracy_profile_@10-fold_cv.pdf}
		\includegraphics[height=1.5in]{assets/[YEAST]precision_profile_@10-fold_cv.png}
		\includegraphics[height=1.5in]{assets/[YEAST]recall_profile_@10-fold_cv.pdf}
...
\vskip 0.2in
	\begin{subfigure}{}
	\centering
		\includegraphics[height=1.5in]{assets/[EMOTION]train_time_profile.pdf}
		\includegraphics[height=1.5in]{assets/[SCENE]train_time_profile.pdf}
		\includegraphics[height=1.5in]{assets/[YEAST]train_time_profile.pdf}
...
\vskip 0.2in
	\begin{subfigure}{}
	\centering
		\includegraphics[width=2.5in]{assets/[EMOTION]acc_conf.pdf}
		\includegraphics[width=2.5in]{assets/[EMOTION]prec_conf.pdf}
		\includegraphics[width=2.5in]{assets/[EMOTION]rec_conf.pdf}
		\includegraphics[width=2.5in]{assets/[EMOTION]hloss_conf.pdf}
...
\vskip 0.2in
	\begin{subfigure}{}
	\centering
		\includegraphics[width=2.5in]{assets/[SCENE]acc_conf.pdf}
		\includegraphics[width=2.5in]{assets/[SCENE]prec_conf.pdf}
		\includegraphics[width=2.5in]{assets/[SCENE]rec_conf.pdf}
		\includegraphics[width=2.5in]{assets/[SCENE]hloss_conf.pdf}
...
%	\begin{subfigure}{}
%	\centering
%		\includegraphics[width=2.5in]{assets/acc_conf.pdf}
%		\includegraphics[width=2.5in]{assets/prec_conf.pdf}
%		\includegraphics[width=2.5in]{assets/rec_conf.pdf}
%		\includegraphics[width=2.5in]{assets/hloss_conf.pdf}
%		\caption{Accuracy (top left), precision (top right), recall (bottom left), and Hamming loss (bottom right) profile of bagging ELM (yellow bar--middle of bins), bagging SVM (dark blue bar--rightmost of bis), and bagging decision stump (red bar--leftmost of bins) for dataset \textsc{Emotion} for different confidence level of threshold coefficient $\alpha$. System evaluated by using 10-fold cross validation scheme.}
%		\label{fig:experiment2}
%	\end{subfigure}
%\vskip -0.2in
%\end{figure*} 
...
%\subsection{Performance Comparison to Other Existing Method}
%\label{comparison}
